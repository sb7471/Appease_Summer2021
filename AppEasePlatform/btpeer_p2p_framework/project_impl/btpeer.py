...
# This peer-to-peer framework was created by Nadeem Abdul Hamid.
# More info about the framework at: http://cs.berry.edu/~nhamid/p2p/framework-python.html
...
class BTPeerConnection:
	...
	# any exceptions thrown upwards
		...
		# RC CHANGE - changed 0 to None
		self.sd = self.s.makefile('rw', None)

	#--------------------------------------------------------------------------
	def __makemsg( self, msgtype, msgdata ):
	#--------------------------------------------------------------------------
		msglen = len(msgdata)
		# RC CHANGE - added .encode('utf-8')
